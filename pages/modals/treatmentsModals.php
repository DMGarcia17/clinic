  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addLabel">Agregar / Modificar Tratamiento</h5>
      ...
      <div class="modal-body">
          <div class="form-group">
            <label for="name">Nombre de la tratamiento</label>
            <input type="text" name="name" id="name" class="form-control">
          </div>
          <input type="hidden" name="id" id="id">
          <div class="form-group">
            <label for="description">Descripci&oacute;n de la tratamiento</label>
          ...
          <div class="form-group">
            <label for="showRP">Mostrar en receta</label>
            <select name="showRP" id="showRP" class="form-control">
              <option value="S">Si</option>
              <option value="N">No</option>
            </select>
          </div>
          <div class="form-group">
            <label for="ptreatment">Tratamiento Pedi&aacute;trico</label>
            <select name="ptreatment" id="ptreatment" class="form-control">
              <option value="S">Si</option>
              <option value="N">No</option>
            </select>
          </div>
