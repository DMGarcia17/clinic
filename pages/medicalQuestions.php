  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-1">
          <div class="col-sm-12">
            <h1 class="m-0">Preguntas Medicas</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <table class="table table-bordered table-striped" id="medicalQuestions" area-label="A table">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Pregunta</th>
...
<!-- ./wrapper -->
<!-- Modal -->
<?php include_once 'modals/medicalQuestionsModals.php' ?>
<!-- REQUIRED SCRIPTS -->
<?php include_once $base.'fragments/scripts.php' ?>
<!-- Data table files -->
<script src=<?php echo $base."dist/js/medicalQuestions.js" ?>></script>
</body>
</html>