  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <table class="table table-bordered table-striped" id="medicines" area-label="A table">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Medicamento</th>
...
<!-- ./wrapper -->
<!-- Modal -->
<?php include_once 'modals/medicineModals.php' ?>
<!-- REQUIRED SCRIPTS -->
<?php include_once $base.'fragments/scripts.php' ?>
<!-- Data table files -->
<script src=<?php echo $base."dist/js/medicines.js" ?>></script>
</body>
</html>