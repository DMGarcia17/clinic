  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <table class="table table-bordered table-striped" id="allergies" area-label="A table">
                    <thead>
                        <tr>
                            <th>Orden</th>
                            <th>Nombre</th>
...
<!-- ./wrapper -->
<!-- Modal -->
<?php include_once 'modals/allergiesModals.php' ?>
<!-- REQUIRED SCRIPTS -->
<?php include_once $base.'fragments/scripts.php' ?>
<!-- Data table files -->
<script src=<?php echo $base."dist/js/allergies.js" ?>></script>
</body>
</html>